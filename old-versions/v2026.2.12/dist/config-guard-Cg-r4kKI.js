import { B as resolveConfigPath, C as setVerbose, D as colorize, J as resolveOAuthDir, L as STATE_DIR, O as isRich, R as isNixMode, W as resolveGatewayPort, X as resolveStateDir, a as parseBooleanValue, et as DEFAULT_CHAT_CHANNEL, f as visibleWidth, k as theme, m as restoreTerminalState, p as defaultRuntime, rt as getChatChannelMeta, st as normalizeChatChannelId, v as danger, y as info } from "./entry.js";
...
import { S as shortenHomePath, _ as resolveHomeDir, x as shortenHomeInString, y as resolveUserPath } from "./utils-DFY1ybN-.js";
import { t as runCommandWithTimeout } from "./exec-B8JKbXKW.js";
import { c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-CnY2bb9p.js";
import { c as writeConfigFile, g as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-CDhe1RIp.js";
import { n as movePathToTrash } from "./server-context-BK5e_pAT.js";
import { i as randomIdempotencyKey, n as callGateway } from "./call-BioUn9nN.js";
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-BdE6IUzJ.js";
...
import { D as runMemoryStatus, E as registerMemoryCli, Gn as CHANNEL_TARGETS_DESCRIPTION, Kn as CHANNEL_TARGET_DESCRIPTION, Sn as CHANNEL_MESSAGE_ACTION_NAMES, _ as randomToken, a as applyWizardMetadata, bn as formatTargetDisplay, c as ensureWorkspaceAndSessions, cn as resolveCommitHash, d as handleReset, f as moveToTrash, fn as runMessageAction, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, ln as lookupContextTokens, m as openUrl, s as detectBrowserOpenSupport, v as resolveControlUiLinks, x as waitForGatewayReachable } from "./loader-BpQdnOY1.js";
...
import { n as setupChannels } from "./onboard-channels-CyP59Qac.js";
import { a as resolveSessionTranscriptsDir, o as resolveSessionTranscriptsDirForAgent, s as resolveStorePath } from "./paths-mF4iWwgm.js";
import { d as loadSessionStore } from "./sandbox-BZDlvSgL.js";
import { n as formatTimeAgo } from "./format-relative-CZOlQ2pA.js";
import { n as runCommandWithRuntime } from "./cli-utils-LcHOt63h.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-DVSe0WU2.js";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-Du6KMoBf.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-D_jqdWkd.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-tKxvDy1w.js";
import { t as createDefaultDeps } from "./deps-BupcTRhd.js";
import { a as gatewayInstallErrorHint, h as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DRvZYeHy.js";
import { t as resolveGatewayService } from "./service-DNcIZ5Kp.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-CNTodvCO.js";
import { t as renderTable } from "./table-oPdyrGsh.js";
import { _ as applyOpenAIConfig, a as applyCustomApiConfig, b as applyGoogleGeminiModelDefault, c as resolveCustomProviderId, g as applyAuthChoice, h as warnIfModelConfigLooksOff, i as CustomApiError, o as parseNonInteractiveCustomApiFlags, v as upsertSharedEnvVar, x as promptAuthChoiceGrouped, y as detectZaiEndpoint } from "./onboard-skills-Dm3VqSUy.js";
import { l as healthCommand } from "./health-format-CXYmhrP-.js";
import { $ as setAnthropicApiKey, C as applyLitellmConfig, E as applyMoonshotConfigCn, Et as validateAnthropicSetupToken, F as applyTogetherConfig, G as applyZaiConfig, L as applyVeniceConfig, N as applySyntheticConfig, T as applyMoonshotConfig, Tt as buildTokenProfileId, U as applyXiaomiConfig, V as applyXaiConfig, at as setMoonshotApiKey, ct as setQianfanApiKey, dt as setVeniceApiKey, et as setCloudflareAiGatewayConfig, f as applyOpencodeZenConfig, ft as setVercelAiGatewayApiKey, g as applyMinimaxConfig, ht as setZaiApiKey, it as setMinimaxApiKey, j as applyQianfanConfig, k as applyOpenrouterConfig, lt as setSyntheticApiKey, m as applyMinimaxApiConfig, mt as setXiaomiApiKey, nt as setKimiCodingApiKey, ot as setOpencodeZenApiKey, pt as setXaiApiKey, rt as setLitellmApiKey, st as setOpenrouterApiKey, tt as setGeminiApiKey, ut as setTogetherApiKey, v as applyAuthProfileConfig, x as applyKimiCodeConfig, y as applyCloudflareAiGatewayConfig, z as applyVercelAiGatewayConfig } from "./github-copilot-auth-byxobEeH.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-Co5BcKdU.js";
import { a as findAgentEntryIndex, c as pruneAgentConfig, d as parseIdentityMarkdown, f as runOnboardingWizard, i as buildAgentSummaries, l as identityHasValues, o as listAgentEntries, r as applyAgentConfig, s as loadAgentIdentity, t as statusCommand } from "./status-BKh4-A7n.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-C0ylUd_S.js";
import { t as formatHelpExamples } from "./help-format-DUy1KRxq.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-CwHxZ977.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-CArPbmvv.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-DQ99-6s0.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-CwHxZ977.js").then((n) => n.t);
