import { F as CONFIG_PATH, G as resolveIsNixMode, J as resolveOAuthDir, K as resolveLegacyStateDirs, M as getResolvedLoggerSettings, W as resolveGatewayPort, X as resolveStateDir, mt as resolveRequiredHomeDir, n as isTruthyEnvValue, p as defaultRuntime, q as resolveNewStateDir } from "./entry.js";
...
import { C as sleep, S as shortenHomePath, _ as resolveHomeDir$1, d as isRecord } from "./utils-DFY1ybN-.js";
...
import { c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, s as resolveAgentWorkspaceDir } from "./agent-scope-CnY2bb9p.js";
import { c as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, u as OpenClawSchema } from "./config-CDhe1RIp.js";
...
import { i as resolveGatewayAuth } from "./auth-wzIZapFN.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BioUn9nN.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-De7qaimJ.js";
import { n as listChannelPlugins } from "./plugins-XU-6noRu.js";
import { _ as randomToken, a as applyWizardMetadata, h as printWizardHeader, t as loadOpenClawPlugins, u as guardCancel } from "./loader-BpQdnOY1.js";
...
import { n as resolveSessionFilePath, o as resolveSessionTranscriptsDirForAgent, s as resolveStorePath } from "./paths-mF4iWwgm.js";
import { I as resolveMainSessionKey, N as canonicalizeMainSessionAlias, W as resolveSandboxScope, d as loadSessionStore, et as DEFAULT_SANDBOX_BROWSER_IMAGE, m as saveSessionStore, nt as DEFAULT_SANDBOX_IMAGE, tt as DEFAULT_SANDBOX_COMMON_IMAGE } from "./sandbox-BZDlvSgL.js";
import { n as isWSLEnv, t as isWSL } from "./wsl-CyBHMKHM.js";
import { d as resolveGatewaySystemdServiceName, f as resolveGatewayWindowsTaskName, l as resolveGatewayLaunchAgentLabel, m as resolveNodeLaunchAgentLabel } from "./constants-JPeoOZnw.js";
import { _ as loadModelCatalog } from "./runner-BnpMFeh_.js";
import { i as readChannelAllowFromStore } from "./pairing-store-CfUkq8QV.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-InQn0nou.js";
import { a as gatewayInstallErrorHint, d as renderSystemNodeWarning, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, p as resolveSystemNodeInfo, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DRvZYeHy.js";
import { a as repairLaunchAgentBootstrap, i as launchAgentPlistExists, n as isLaunchAgentListed, o as resolveGatewayLogPaths, r as isLaunchAgentLoaded, t as resolveGatewayService } from "./service-DNcIZ5Kp.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-CNTodvCO.js";
import { n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail } from "./systemd-hints-BldOI5yE.js";
import { a as renderGatewayServiceCleanupHints, i as findExtraGatewayServices, n as auditGatewayServiceConfig, o as readLastGatewayErrorLine, r as needsNodeRuntimeMigration, t as SERVICE_AUDIT_CODES } from "./service-audit-_vKJ8CE1.js";
import { i as resolveControlUiDistIndexPathForRoot, l as healthCommand, r as resolveControlUiDistIndexHealth, t as formatHealthCheckFailure } from "./health-format-CXYmhrP-.js";
import { f as doctorShellCompletion, t as runGatewayUpdate } from "./update-runner-tK9nTr1M.js";
...
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-rbSQ7wmC.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CArPbmvv.js";
