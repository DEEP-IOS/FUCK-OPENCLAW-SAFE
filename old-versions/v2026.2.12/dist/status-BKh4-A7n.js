...
import { Ct as DEFAULT_CONTEXT_TOKENS, N as resolveConfiguredModelRef, Tt as DEFAULT_PROVIDER, _ as ensureAuthProfileStore, wt as DEFAULT_MODEL } from "./auth-profiles-CNzIocqc.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-DdHwx_z_.js";
import { l as normalizeAgentId, y as parseAgentSessionKey } from "./session-key-DVvxnFKg.js";
import { h as pathExists, y as resolveUserPath } from "./utils-DFY1ybN-.js";
import { n as runExec } from "./exec-B8JKbXKW.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-BKsZvO6K.js";
import { c as resolveDefaultAgentId, h as DEFAULT_IDENTITY_FILENAME, p as DEFAULT_BOOTSTRAP_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-CnY2bb9p.js";
import { M as VERSION, c as writeConfigFile, i as loadConfig, o as readConfigFileSnapshot } from "./config-CDhe1RIp.js";
import { d as formatPortDiagnostics, l as inspectPortUsage } from "./chrome-D8B1fI6a.js";
import { d as getTailnetHostname, f as readTailscaleStatusJson, u as findTailscaleBinary } from "./auth-wzIZapFN.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BioUn9nN.js";
import { n as listChannelPlugins } from "./plugins-XU-6noRu.js";
import { $n as peekSystemEvents, Kt as loadProviderUsageSummary, Nn as readRestartSentinel, Nt as sha256HexPrefix, Pn as summarizeRestartSentinel, Pr as getMemorySearchManager, X as getRemoteSkillEligibility, Xt as listAgentsForGateway, _ as randomToken, a as applyWizardMetadata, b as summarizeExistingConfig, c as ensureWorkspaceAndSessions, d as handleReset, g as probeGatewayReachable, h as printWizardHeader, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, ln as lookupContextTokens, m as openUrl, p as normalizeGatewayTokenInput, q as buildChannelSummary, qt as formatUsageReportLines, s as detectBrowserOpenSupport, v as resolveControlUiLinks, w as normalizeControlUiBasePath, x as waitForGatewayReachable } from "./loader-BpQdnOY1.js";
...
import { s as resolveStorePath } from "./paths-mF4iWwgm.js";
import { I as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-BZDlvSgL.js";
...
import { t as collectChannelStatusIssues } from "./channels-status-issues-InQn0nou.js";
import { r as installCompletion } from "./completion-cli-BQPuDrTS.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DRvZYeHy.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-DNcIZ5Kp.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-CNTodvCO.js";
import { o as readLastGatewayErrorLine } from "./service-audit-_vKJ8CE1.js";
import { t as renderTable } from "./table-oPdyrGsh.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-tUBEFViY.js";
import { d as applyPrimaryModel, f as promptDefaultModel, g as applyAuthChoice, h as warnIfModelConfigLooksOff, m as resolvePreferredProviderForAuthChoice, r as promptRemoteGatewayConfig, s as promptCustomApiConfig, t as setupSkills, x as promptAuthChoiceGrouped } from "./onboard-skills-Dm3VqSUy.js";
import { l as healthCommand, n as ensureControlUiAssetsBuilt, s as formatHealthChannelLines, t as formatHealthCheckFailure, u as resolveHeartbeatSummaryForAgent } from "./health-format-CXYmhrP-.js";
import { C as resolveEffectiveUpdateChannel, S as normalizeUpdateChannel, c as formatUpdateOneLiner, d as checkShellCompletionStatus, h as compareSemverStrings, l as getUpdateCheckResult, m as checkUpdateStatus, p as ensureCompletionCacheExists, s as formatUpdateAvailableHint, u as resolveUpdateAvailability, x as formatUpdateChannelLabel } from "./update-runner-tK9nTr1M.js";
import { n as logConfigUpdated } from "./logging-Co5BcKdU.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-DQiV1ulN.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Dknt5QmB.js";
import { t as runTui } from "./tui-Dp_597lz.js";
import { t as resolveNodeService } from "./node-service-_vgO5xR-.js";
import { n as redactSecrets, t as formatGatewayAuthUsed } from "./format-CNU-Zkrz.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CArPbmvv.js").then((n) => n.r);
