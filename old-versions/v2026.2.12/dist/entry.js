...
if (!ensureExperimentalWarningSuppressed()) {
	...
	import("./run-main-w6FjSYWf.js").then(({ runCli }) => runCli(process$1.argv)).catch((error) => {
...
//#endregion
export { CHAT_CHANNEL_ORDER as $, getChildLogger as A, resolveConfigPath as B, setVerbose as C, colorize as D, warn as E, CONFIG_PATH as F, resolveIsNixMode as G, resolveDefaultConfigCandidates as H, DEFAULT_GATEWAY_PORT as I, resolveOAuthDir as J, resolveLegacyStateDirs as K, STATE_DIR as L, getResolvedLoggerSettings as M, toPinoLikeLogger as N, isRich as O, normalizeLogLevel as P, CHANNEL_IDS as Q, isNixMode as R, logVerboseConsole as S, success as T, resolveGatewayLockDir as U, resolveConfigPathCandidate as V, resolveGatewayPort as W, resolveStateDir as X, resolveOAuthPath as Y, resolvePreferredOpenClawTmpDir as Z, unregisterActiveProgressLine as _, parseBooleanValue as a, normalizeAnyChannelId as at, isVerbose as b, enableConsoleCapture as c, getActivePluginRegistry as ct, shouldLogSubsystemToConsole as d, normalizeProfileName as dt, DEFAULT_CHAT_CHANNEL as et, visibleWidth as f, expandHomePrefix as ft, registerActiveProgressLine as g, clearActiveProgressLine as h, normalizeEnv as i, listChatChannels as it, getLogger as j, theme as k, setConsoleSubsystemFilter as l, requireActivePluginRegistry as lt, restoreTerminalState as m, resolveRequiredHomeDir as mt, isTruthyEnvValue as n, formatChannelSelectionLine as nt, createSubsystemLogger as o, normalizeChannelId as ot, defaultRuntime as p, resolveEffectiveHomeDir as pt, resolveNewStateDir as q, logAcceptedEnvOption as r, getChatChannelMeta as rt, runtimeForLogger as s, normalizeChatChannelId as st, installProcessWarningFilter as t, formatChannelPrimerLine as tt, setConsoleTimestampPrefix as u, setActivePluginRegistry as ut, danger as v, shouldLogVerbose as w, logVerbose as x, info as y, resolveCanonicalConfigPath as z };