import { et as DEFAULT_CHAT_CHANNEL, p as defaultRuntime } from "./entry.js";
import { C as buildAllowedModelSet, Ct as DEFAULT_CONTEXT_TOKENS, D as isCliProvider, L as resolveThinkingDefault, N as resolveConfiguredModelRef, O as modelKey, Tt as DEFAULT_PROVIDER, _ as ensureAuthProfileStore, wt as DEFAULT_MODEL } from "./auth-profiles-CNzIocqc.js";
...
import { a as resolveAgentModelPrimary, i as resolveAgentModelFallbacksOverride, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, x as ensureAgentWorkspace } from "./agent-scope-CnY2bb9p.js";
import { i as loadConfig } from "./config-CDhe1RIp.js";
import { a as isInternalMessageChannel, d as resolveMessageChannel, i as isGatewayMessageChannel, l as normalizeMessageChannel, n as isDeliverableMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-BdE6IUzJ.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-XU-6noRu.js";
import { At as runEmbeddedPiAgent, Cn as runWithModelFallback, G as setCliSessionId, Gt as applyModelOverrideToSessionEntry, It as resolveAgentTimeoutMs, K as runCliAgent, Lt as clearAgentRunContext, Rt as emitAgentEvent, Vt as registerAgentRunContext, W as getCliSessionId, Wt as AGENT_LANE_NESTED, X as getRemoteSkillEligibility, Y as resolveSendPolicy, dt as clearSessionAuthProfileOverride, ft as applyVerboseOverride, ln as lookupContextTokens, lt as getSkillsSnapshotVersion, vn as resolveOutboundTarget, yn as resolveSessionDeliveryTarget } from "./loader-BpQdnOY1.js";
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-Dlw-4HTg.js";
import { n as resolveSessionFilePath, s as resolveStorePath } from "./paths-mF4iWwgm.js";
import { H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, W as normalizeVerboseLevel } from "./pi-embedded-helpers-DVDkr-zC.js";
import { A as resolveSessionResetType, D as evaluateSessionFreshness, E as resolveSessionKey, F as resolveExplicitAgentSessionKey, O as resolveChannelResetConfig, T as normalizeAccountId, d as loadSessionStore, g as updateSessionStore, k as resolveSessionResetPolicy } from "./sandbox-BZDlvSgL.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-BOqBE1bl.js";
import { l as deriveSessionTotalTokens, u as hasNonzeroUsage } from "./session-cost-usage-C0xHMSdN.js";
