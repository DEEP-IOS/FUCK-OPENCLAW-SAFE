import { $ as CHAT_CHANNEL_ORDER, L as STATE_DIR, Q as CHANNEL_IDS, lt as requireActivePluginRegistry, o as createSubsystemLogger, p as defaultRuntime, rt as getChatChannelMeta } from "./entry.js";
...
import { c as escapeRegExp, m as normalizeE164, y as resolveUserPath } from "./utils-DFY1ybN-.js";
import { b as DEFAULT_USER_FILENAME, d as DEFAULT_AGENTS_FILENAME, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, l as resolveSessionAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, p as DEFAULT_BOOTSTRAP_FILENAME, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-CnY2bb9p.js";
import { d as parseByteSize, g as parseDurationMs, i as loadConfig } from "./config-CDhe1RIp.js";
import { o as resolveProfile, t as createBrowserRouteContext } from "./server-context-BK5e_pAT.js";
import { A as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, D as DEFAULT_BROWSER_EVALUATE_ENABLED, O as DEFAULT_OPENCLAW_BROWSER_COLOR } from "./chrome-D8B1fI6a.js";
import { c as listDeliverableMessageChannels, l as normalizeMessageChannel } from "./message-channel-BdE6IUzJ.js";
import { _ as normalizeChatType, a as normalizeWhatsAppTarget, c as resolveTelegramAccount, m as resolveSlackReplyToMode, p as resolveSlackAccount, r as normalizeChannelId, y as resolveDiscordAccount } from "./plugins-XU-6noRu.js";
import { n as resolveWhatsAppAccount } from "./accounts-DH0MoGU2.js";
import { n as resolveSessionFilePath, t as resolveDefaultSessionStorePath } from "./paths-mF4iWwgm.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-BtNd-j6q.js";
import { t as registerBrowserRoutes } from "./routes-CQcgE2QD.js";
import { o as syncSkillsToWorkspace } from "./skills-BOqBE1bl.js";
