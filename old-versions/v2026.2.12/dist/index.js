...
import { D as info, E as danger, I as colorize, L as isRich, M as setVerbose, R as theme, S as normalizeChatChannelId, c as defaultRuntime, h as DEFAULT_CHAT_CHANNEL, l as restoreTerminalState, r as enableConsoleCapture, s as visibleWidth, v as getChatChannelMeta } from "./subsystem-skqGO1bX.js";
import { C as shortenHomePath, E as toWhatsappJid, S as shortenHomeInString, b as resolveUserPath, h as normalizeE164, n as assertWebChannel, v as resolveHomeDir } from "./utils-CIzK7l-0.js";
import "./pi-embedded-helpers-40Sotf9d.js";
import { Ct as formatControlUiSshHint, D as runMessageAction, Et as moveToTrash, Ft as waitForGatewayReachable, I as CHANNEL_MESSAGE_ACTION_NAMES, Mt as resolveControlUiLinks, Ot as openUrl, P as formatTargetDisplay, Sr as lookupContextTokens, St as ensureWorkspaceAndSessions, Tt as handleReset, an as registerMemoryCli, at as CHANNEL_TARGETS_DESCRIPTION, ht as resolveCommitHash, jt as randomToken, on as runMemoryStatus, ot as CHANNEL_TARGET_DESCRIPTION, sn as monitorWebChannel, t as getReplyFromConfig, un as waitForever, vt as DEFAULT_WORKSPACE, xt as detectBrowserOpenSupport, yt as applyWizardMetadata } from "./reply-B5GoyKpI.js";
import { l as normalizeAgentId, n as DEFAULT_AGENT_ID, t as DEFAULT_ACCOUNT_ID } from "./session-key-BWxPj0z_.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-DeTCzdN-.js";
import { c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-BeIpLGAL.js";
import { Dt as DEFAULT_MODEL, Et as DEFAULT_CONTEXT_TOKENS, H as resolveEnvApiKey, Ot as DEFAULT_PROVIDER, St as normalizeSecretInput, at as resolveApiKeyForProfile, d as resolveConfiguredModelRef, et as resolveAuthProfileOrder, ht as ensureAuthProfileStore, mt as upsertAuthProfile, s as normalizeProviderId, vt as resolveAuthStorePath, xt as normalizeOptionalSecretInput } from "./model-selection-Dc-MAbI_.js";
...
import { r as normalizeEnv, t as isTruthyEnvValue } from "./env-DLkW-xAN.js";
import { M as VERSION, N as loadDotEnv, c as writeConfigFile, g as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-Drc5OJ4W.js";
...
import { D as resolveSessionKey, E as deriveSessionKey, d as loadSessionStore, m as saveSessionStore } from "./sandbox-Bz_i-Ifh.js";
import { d as installUnhandledRejectionHandler, v as applyTemplate } from "./runner-B7MhzgLA.js";
import "./image-irJRtqER.js";
import "./pi-model-discovery-EwKVHlZB.js";
import { c as describePortOwner, l as ensurePortAvailable, s as PortInUseError, u as handlePortError } from "./chrome-DZ9AMNm6.js";
...
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-DHsuTWdZ.js";
import "./logging-fywhKCmE.js";
import "./accounts-oj7wQjQH.js";
import { a as resolveSessionTranscriptsDir, o as resolveSessionTranscriptsDirForAgent, s as resolveStorePath } from "./paths-B49s6UZQ.js";
...
import { i as randomIdempotencyKey, n as callGateway } from "./call-CaQDI0e9.js";
...
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-BOW8yhGa.js";
import "./pairing-labels-BWXNgWNU.js";
import "./session-cost-usage-D7HuoSSD.js";
import { m as promptYesNo, p as ensureBinary } from "./auth-DAsS25cF.js";
import "./control-auth-BND74hg3.js";
import "./control-service-Cnii_zCx.js";
import "./channel-selection-Cam3iEhe.js";
import { t as createDefaultDeps } from "./deps-B_Ot2OP_.js";
import { t as isMainModule } from "./is-main-BWoXGz7p.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-32CHhkWx.js";
import { a as gatewayInstallErrorHint, g as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-Bc24Cftn.js";
import { a as buildAgentSummaries, c as loadAgentIdentity, f as parseIdentityMarkdown, i as applyAgentConfig, l as pruneAgentConfig, n as statusCommand, o as findAgentEntryIndex, s as listAgentEntries, t as runOnboardingWizard, u as identityHasValues } from "./onboarding-DIqLb-Jh.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-HyeZXsnu.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-BWHTA2M3.js";
import "./note-qHgj6Rpk.js";
import { t as WizardCancelledError } from "./prompts-Bg96reub.js";
import { t as createClackPrompter } from "./clack-prompter-BK56JPY7.js";
import { S as promptAuthChoiceGrouped, _ as applyAuthChoice, a as CustomApiError, b as detectZaiEndpoint, g as warnIfModelConfigLooksOff, l as resolveCustomProviderId, o as applyCustomApiConfig, s as parseNonInteractiveCustomApiFlags, v as applyOpenAIConfig, x as applyGoogleGeminiModelDefault, y as upsertSharedEnvVar } from "./onboard-skills-CUsNafXq.js";
import { $ as setAnthropicApiKey, C as applyLitellmConfig, E as applyMoonshotConfigCn, Et as validateAnthropicSetupToken, F as applyTogetherConfig, G as applyZaiConfig, L as applyVeniceConfig, N as applySyntheticConfig, T as applyMoonshotConfig, Tt as buildTokenProfileId, U as applyXiaomiConfig, V as applyXaiConfig, at as setMoonshotApiKey, ct as setQianfanApiKey, dt as setVeniceApiKey, et as setCloudflareAiGatewayConfig, f as applyOpencodeZenConfig, ft as setVercelAiGatewayApiKey, g as applyMinimaxConfig, ht as setZaiApiKey, it as setMinimaxApiKey, j as applyQianfanConfig, k as applyOpenrouterConfig, lt as setSyntheticApiKey, m as applyMinimaxApiConfig, mt as setXiaomiApiKey, nt as setKimiCodingApiKey, ot as setOpencodeZenApiKey, pt as setXaiApiKey, rt as setLitellmApiKey, st as setOpenrouterApiKey, tt as setGeminiApiKey, ut as setTogetherApiKey, v as applyAuthProfileConfig, x as applyKimiCodeConfig, y as applyCloudflareAiGatewayConfig, z as applyVercelAiGatewayConfig } from "./github-copilot-auth-6zTFqx7-.js";
import { n as setupChannels } from "./onboard-channels-B0d7LdR-.js";
import "./plugin-auto-enable-CHWHaH3d.js";
import "./archive-beaSfAzA.js";
import "./skill-scanner-CucvxYhu.js";
import "./installs-Ce7Qv3SM.js";
import { l as healthCommand } from "./health-format-POaTlrTa.js";
import "./update-runner-BGzdDdnE.js";
import "./audit-_a_tFvz4.js";
import { t as renderTable } from "./table-C6yF3iyw.js";
import "./skills-status-D4Hv21QE.js";
import { t as resolveGatewayService } from "./service-DH3HqFXb.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-Cd0QjLXf.js";
import "./service-audit-CFGQfHld.js";
import "./node-service-DDqROK73.js";
import "./channels-status-issues-BDzPgl_s.js";
import { c as registerSubCliCommands, d as getPositiveIntFlagValue, f as getVerboseFlag, l as getCommandPath, m as hasHelpOrVersion, p as hasFlag, u as getFlagValue } from "./completion-cli-BfUVzihZ.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-d__EQwsD.js";
import { t as formatHelpExamples } from "./help-format-T2Vl08hr.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-DIUWm8lX.js";
import { i as hasExplicitOptions, n as resolveCliChannelOptions, r as ensurePluginRegistryLoaded } from "./channel-options-DL2z1AUp.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-8O7IVGO-.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-CP4GtrTW.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-D82RPJnM.js";
import "./widearea-dns-JCUWV3UQ.js";
import "./auth-health-D01ClVGi.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-BgzIg5dq.js";
import "./hooks-status-BRn0eqQO.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-CP4GtrTW.js").then((n) => n.t);
