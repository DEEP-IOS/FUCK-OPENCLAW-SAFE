...
import { Vt as createDefaultDeps, t as getReplyFromConfig, wt as resolveCommitHash } from "./reply-DM7CfktL.js";
...
import { H as VERSION, W as loadDotEnv, i as loadConfig } from "./config-DJkRS0fq.js";
import "./manifest-registry-D2lPzXIl.js";
import { _ as applyTemplate, u as installUnhandledRejectionHandler } from "./runner-DV9BztqI.js";
...
import { i as handlePortError, n as describePortOwner, r as ensurePortAvailable, t as PortInUseError } from "./ports-BrLmtCv4.js";
import "./trash-DXPbQEbW.js";
import { A as deriveSessionKey, j as resolveSessionKey, l as saveSessionStore, o as loadSessionStore } from "./sessions-BpJAqQ8e.js";
...
import { r as waitForever, t as monitorWebChannel } from "./channel-web-CncmqUCp.js";
import "./outbound-CNkkqjJQ.js";
import "./session-CWZfX26f.js";
import "./login-OArlxyJ8.js";
...
import { i as getCoreCliCommandsWithSubcommands, n as setProgramContext, o as registerProgramCommands, s as getSubCliCommandsWithSubcommands } from "./program-context-DDvCpzMM.js";
import "./catalog-DxFePbMV.js";
import "./plugin-registry-DvMqxc9E.js";
import { n as resolveCliChannelOptions } from "./channel-options-Bpf58tTp.js";
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		const { ensureConfigReady } = await import("./config-guard-BFo-9y4Y.js");
		await ensureConfigReady({
			runtime: defaultRuntime,
			commandPath
		});
		if (PLUGIN_REQUIRED_COMMANDS.has(commandPath[0])) {
			const { ensurePluginRegistryLoaded } = await import("./plugin-registry-DvMqxc9E.js").then((n) => n.n);
