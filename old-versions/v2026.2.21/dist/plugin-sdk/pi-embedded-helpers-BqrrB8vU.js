...
import { r as normalizeChannelId } from "./plugins-BYg0Y0s6.js";
import { A as normalizeE164, P as resolveUserPath, V as truncateUtf16Safe, t as CHANNEL_IDS, ut as resolvePreferredOpenClawTmpDir } from "./registry-D44cLNno.js";
import { R as parseDurationMs, a as writeConfigFile, n as loadConfig, s as parseByteSize, t as createConfigIO } from "./config-Bn_wS7mW.js";
import { i as defaultRuntime, t as createSubsystemLogger } from "./subsystem-Afj3hpsW.js";
import { i as parseBooleanValue, t as formatCliCommand } from "./command-format-qHzyzLJ8.js";
import { U as resolveProcessScopedMap, W as isPidAlive } from "./model-selection-Cdlm04wt.js";
import { E as runExec, _ as DEFAULT_SOUL_FILENAME, b as ensureAgentWorkspace, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, m as DEFAULT_BOOTSTRAP_FILENAME, n as resolveAgentConfig, p as DEFAULT_AGENT_WORKSPACE_DIR, u as resolveSessionAgentId, v as DEFAULT_TOOLS_FILENAME, y as DEFAULT_USER_FILENAME } from "./agent-scope-B5u6KQ8F.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-Bv8oZiTO.js";
import { b as openFileWithinRoot, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, y as SafeOpenError } from "./image-ops-BC90Ra0D.js";
import { t as SsrFBlockedError } from "./ssrf-DKZ8eBrk.js";
import { o as listDeliverableMessageChannels, s as normalizeMessageChannel } from "./message-channel-OSNp3I52.js";
import { t as normalizeChatType } from "./chat-type-CEMQNtWX.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-KUfGrzBt.js";
import { a as syncSkillsToWorkspace, h as safeEqualSecret, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-Bl-JEvpV.js";
import { A as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, C as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, D as DEFAULT_BROWSER_EVALUATE_ENABLED, E as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, O as DEFAULT_OPENCLAW_BROWSER_COLOR, S as stopChromeExtensionRelayServer, T as DEFAULT_AI_SNAPSHOT_MAX_CHARS, _ as fetchJson, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as appendCdpPath, h as withBrowserNavigationPolicy, i as launchOpenClawChrome, j as isLoopbackHost, k as DEFAULT_OPENCLAW_BROWSER_ENABLED, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchOk, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, x as ensureChromeExtensionRelayServer } from "./chrome-BxmBGAa7.js";
import { A as normalizeHyphenSlug, d as getChannelDock, o as normalizeThinkLevel } from "./thinking-DBoJCGt5.js";
...
import { i as saveMediaBuffer, t as ensureMediaDir } from "./store-CNae9hby.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CHSHAMgZ.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CHSHAMgZ.js")).closePlaywrightBrowserConnection();
		} catch {}
