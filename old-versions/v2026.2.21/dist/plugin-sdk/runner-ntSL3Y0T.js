...
import { S as resolveIMessageAttachmentRoots, b as isInboundPathAllowed, n as loadConfig, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-Bn_wS7mW.js";
import { B as resolveOpenClawAgentDir, T as resolveApiKeyForProvider, c as normalizeProviderId, h as normalizeGoogleModelId, w as requireApiKey } from "./model-selection-Cdlm04wt.js";
import { E as runExec } from "./agent-scope-B5u6KQ8F.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-BC90Ra0D.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, o as fetchWithSsrFGuard, r as MediaFetchError } from "./local-roots-eVU4Vfxy.js";
import { t as normalizeChatType } from "./chat-type-CEMQNtWX.js";
import { t as describeImageWithModel, x as ensureOpenClawModelsJson } from "./image-DEdau8hK.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-CNwwR0BT.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-C0LwFptO.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
