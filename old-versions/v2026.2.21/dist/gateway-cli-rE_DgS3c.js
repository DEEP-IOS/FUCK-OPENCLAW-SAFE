...
import { f as loadGatewayTlsRuntime$1, l as authorizeOperatorScopesForMethod, n as callGateway, s as ADMIN_SCOPE$3, u as isNodeRoleMethod } from "./call-ZNr9p4dX.js";
...
import { $n as resolveTtsProviderOrder, A as resolveAgentAvatar, An as normalizeMimeList, At as normalizeRequiredName, Bt as isExternalHookSession, C as agentCommand, Ct as normalizeCronJobCreate, D as createOutboundSendDeps, Dn as DEFAULT_INPUT_TIMEOUT_MS, Dt as normalizeOptionalSessionKey, E as resolveAgentOutboundTarget, En as DEFAULT_INPUT_MAX_REDIRECTS, Et as normalizeOptionalAgentId, Gn as resolveUserTimezone, Gt as emitGatewayRestart, H as dispatchInboundMessage, Hn as stopSubagentsForRequester, Ht as persistBrowserProxyFiles, Jn as isTtsProviderConfigured, Jt as scheduleGatewaySigusr1Restart, Kn as getTtsProvider, Kt as isGatewaySigusr1RestartExternallyAllowed, L as buildHistoryContextFromEntries, Lt as buildSafeExternalPrompt, Mt as buildDeliveryFromLegacyPayload, Nn as resolveAgentTimeoutMs, Nt as hasLegacyDeliveryHints, O as createDefaultDeps, On as extractFileContentFromSource, Ot as normalizeOptionalText, Pt as stripLegacyDeliveryFields, Q as runCliAgent, Qn as resolveTtsPrefsPath, Qt as normalizeGroupActivation, Rn as formatZonedTimestamp, Rt as detectSuspiciousPatterns, S as sleepWithAbort, St as normalizeHttpWebhookUrl, T as resolveAgentDeliveryPlan, Tn as DEFAULT_INPUT_IMAGE_MIMES, Tt as inferLegacyName, U as createReplyDispatcher, Ut as consumeGatewaySigusr1RestartAuthorization, Vn as isAbortTrigger, Vt as applyBrowserProxyPaths, W as getTotalPendingReplies, Wt as deferGatewayRestartUntilIdle, X as getCliSessionId, Xn as resolveTtsAutoMode, Xt as setPreRestartDeferralCheck, Y as resolveCronStyleNow, Yn as resolveTtsApiKey, Yt as setGatewaySigusr1RestartPolicy, Z as setCliSessionId, Zn as resolveTtsConfig, Zt as unbindThreadBindingsBySessionKey, _n as applyModelOverrideToSessionEntry, _r as clearAgentRunContext, _t as formatRestartSentinelMessage, a as runSubagentAnnounceFlow, ar as getActiveTaskCount, at as resolveOutboundSessionRoute, b as requestBodyErrorToText, bn as enqueueSystemEvent, br as onAgentEvent, c as abortEmbeddedPiRun, cn as requestHeartbeatNow, cr as resetAllLanes, ct as resolveOutboundTarget, d as applyToolPolicyPipeline, dn as normalizeSendPolicy, dr as CommandLane, dt as resetDirectoryCache, en as loadProviderUsageSummary, er as setTtsEnabled, et as createOpenClawTools, f as buildDefaultToolPolicyPipelineSteps, fn as resolveSendPolicy, fr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, g as loadOpenClawPlugins, gr as stripHeartbeatToken, gt as formatDoctorNonInteractiveHint, ht as consumeRestartSentinel, ir as OPENAI_TTS_VOICES, it as ensureOutboundSessionEntry, jn as resolveInputFileLimits, jt as migrateLegacyCronPayload, k as createOutboundSendDeps$1, kn as extractImageContentFromSource, kt as normalizePayloadToSystemText, l as getActiveEmbeddedRunCount, lr as setCommandLaneConcurrency, lt as resolveSessionDeliveryTarget, m as getPluginToolMeta, n as initSubagentRegistry, nr as textToSpeech, nt as resolveAnnounceTargetFromKey, o as clearSessionQueues, pt as runWithModelFallback, q as BARE_SESSION_RESET_PROMPT, qn as isTtsEnabled, qt as markGatewaySigusr1RestartHandled, r as listDescendantRunsForRequester, rr as OPENAI_TTS_MODELS, s as runEmbeddedPiAgent, sr as getTotalQueueSize, t as countActiveDescendantRuns, tr as setTtsProvider, tt as readLatestAssistantReply, u as waitForEmbeddedPiRunEnd, ur as waitForActiveTasks, v as handleSlackHttpRequest, vn as applyVerboseOverride, vr as emitAgentEvent, wn as DEFAULT_INPUT_IMAGE_MAX_BYTES, wt as normalizeCronJobPatch, x as computeBackoff, xn as isSystemEventContextChanged, xr as registerAgentRunContext, xt as writeRestartSentinel, y as readJsonBodyWithLimit, yn as parseVerboseOverride, yr as getAgentRunContext, yt as summarizeRestartSentinel, zt as getHookType } from "./subagent-registry-DV5OCO20.js";
import { D as resolveSessionResetPolicy, F as resolveMainSessionKey, H as cleanStaleLockFiles, I as resolveMainSessionKeyFromConfig, J as normalizeSessionDeliveryFields, K as mergeDeliveryContext, M as canonicalizeMainSessionAlias, N as resolveAgentMainSessionKey, P as resolveExplicitAgentSessionKey, R as snapshotSessionOrigin, S as stripEnvelopeFromMessages, T as evaluateSessionFreshness, W as deliveryContextFromSession, _ as capArrayByJsonBytes, d as updateSessionStore, g as archiveSessionTranscripts, h as archiveFileOnDisk, n as parseSessionThreadInfo, o as loadSessionStore, t as extractDeliveryInfo, v as readSessionMessages, x as resolveSessionTranscriptCandidates, y as readSessionPreviewItemsFromTranscript } from "./sessions-DmaergeJ.js";
...
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName } from "./with-timeout-Dm6ED9Vh.js";
import { C as getGlobalHookRunner, T as runGlobalGatewayStopSafely, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-CMEoPFLx.js";
...
import { S as resolveToolProfilePolicy, _ as collectExplicitAllowlist, b as mergeAlsoAllowPolicy } from "./sandbox-CoUdrbXS.js";
...
import { g as mergeGatewayTailscaleConfig, h as ensureGatewayStartupAuth } from "./server-context-CQlBYQD7.js";
...
import { i as formatPortDiagnostics, n as inspectPortUsage, t as ensurePortAvailable } from "./ports-Dh8U6PTu.js";
...
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-C71KenfK.js";
...
import { d as registerUnhandledRejectionHandler } from "./runner-CMatzMlG.js";
import { n as loadModelCatalog } from "./model-catalog-CRuPJUbw.js";
...
import { S as registerSkillsChangeListener, _ as requestNodePairing, c as recordRemoteNodeInfo, d as removeRemoteNodeInfo, f as setSkillsRemoteRegistry, g as renamePairedNode, h as rejectNodePairing, l as refreshRemoteBinsForConnectedNodes, m as listNodePairing, o as getRemoteSkillEligibility, p as approveNodePairing, s as primeRemoteSkillsCache, u as refreshRemoteNodeBins, v as updatePairedNodeMetadata, x as getSkillsSnapshotVersion, y as verifyNodeToken } from "./skill-commands-uwHRWdJn.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DVvmMbIu.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-Bl185_aX.js";
import "./fetch-DLXV2q8j.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-DK5-bAn8.js";
import "./nodes-screen-B9hOtN5Z.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-C-v6E-Lz.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-BXPHPKra.js";
...
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-hWAwsPST.js";
...
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-BjJHxhjk.js";
import "./prompt-style-DwCXob2h.js";
import "./pairing-labels-D5pZ7KsY.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-BdpmCOVo.js";
...
import "./lifecycle-core-DwAXpX7Q.js";
import "./systemd-hints-sLM41s35.js";
import { t as parsePort$1 } from "./parse-port-DnJYkByg.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-DQs3bsbH.js";
...
import { c as probeGateway, o as isNodeCommandAllowed, s as resolveNodeCommandAllowlist } from "./audit-BsyEkY-t.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-Dey40AZW.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-BsMO1u1v.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-C5fIqN53.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-JUnNDkqJ.js";
...
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-8V6j5_x2.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-DWI9N-Ks.js";
import { n as forceFreePortAndWait } from "./ports-lX_eh20K.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-GJznxpIP.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-C-v6E-Lz.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-hWAwsPST.js").then((n) => n.t);
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-CMEoPFLx.js").then((n) => n.n);
