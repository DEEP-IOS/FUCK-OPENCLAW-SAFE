...
var n$10 = class {
	...
	get styleSheet() {
		...
		if (e$13 && void 0 === t) {
			...
			e && (t = o$13.get(s)), void 0 === t && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), e && o$13.set(s, t));
		}
		return t;
	}
	toString() {
...
const r$10 = (t) => new n$10("string" == typeof t ? t : t + "", void 0, s$8), i$9 = (t, ...e) => {
	const o = 1 === t.length ? t[0] : e.reduce((e, s, o) => e + ((t) => {
		if (!0 === t._$cssResult$) return t.cssText;
		if ("number" == typeof t) return t;
		throw Error("Value passed to 'css' function must be a 'css' function result: " + t + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
	})(s) + t[o + 1], t[0]);
	return new n$10(o, t, s$8);
}, S$1 = (s, o) => {
...
* SPDX-License-Identifier: BSD-3-Clause
*/ const { is: i$8, defineProperty: e$12, getOwnPropertyDescriptor: h$6, getOwnPropertyNames: r$9, getOwnPropertySymbols: o$12, getPrototypeOf: n$9 } = Object, a$1 = globalThis, c$5 = a$1.trustedTypes, l$4 = c$5 ? c$5.emptyScript : "", p$2 = a$1.reactiveElementPolyfillSupport, d$2 = (t, s) => t, u$3 = {
	toAttribute(t, s) {
		switch (s) {
			case Boolean:
				t = t ? l$4 : null;
...
var y$1 = class extends HTMLElement {
	...
	static finalize() {
		...
		if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(d$2("properties"))) {
			const t = this.properties, s = [...r$9(t), ...o$12(t)];
...
const N = (t, i) => {
	...
	for (let i = 0; i < s; i++) {
		...
		l += c === v$1 ? s + r$8 : d >= 0 ? (e.push(a), s.slice(0, d) + h$5 + s.slice(d) + o$11 + x) : s + o$11 + (-2 === d ? i : x);
	}
		...
		for (; null !== (r = P.nextNode()) && d.length < u;) {
			if (1 === r.nodeType) {
				if (r.hasAttributes()) for (const t of r.getAttributeNames()) if (t.endsWith(h$5)) {
					const i = v[a++], s = r.getAttribute(t).split(o$11), e = /([.?@])?(.*)/.exec(i);
					d.push({
						type: 1,
						index: l,
						name: e[2],
				...
				} else t.startsWith(o$11) && (d.push({
					type: 6,
					index: l
				}), r.removeAttribute(t));
				if (y.test(r.tagName)) {
					const t = r.textContent.split(o$11), i = t.length - 1;
					if (i > 0) {
			...
			} else if (8 === r.nodeType) if (r.data === n$8) d.push({
				type: 2,
				index: l
			});
			else {
				let t = -1;
				for (; -1 !== (t = r.data.indexOf(o$11, t + 1));) d.push({
					type: 7,
					index: l
				}), t += o$11.length - 1;
			}
...
* SPDX-License-Identifier: BSD-3-Clause
*/ const { I: t$3 } = j$1, i$4 = (o) => o, n$6 = (o) => null === o || "object" != typeof o && "function" != typeof o, e$9 = {
	HTML: 1,
	SVG: 2,
	MATHML: 3
}, l$2 = (o, t) => void 0 === t ? void 0 !== o?._$litType$ : o?._$litType$ === t, d = (o) => null != o?._$litType$?.h, c$3 = (o) => void 0 !== o?._$litDirective$, f$1 = (o) => o?._$litDirective$, r$7 = (o) => void 0 === o.strings, s$5 = () => document.createComment(""), v = (o, n, e) => {
...
function n$4(t) {
	return (e, o) => "object" == typeof o ? r$6(t, e, o) : ((t, e, o) => {
...
* SPDX-License-Identifier: BSD-3-Clause
*/ const i$2 = Symbol("SignalWatcherBrand"), s$1 = new FinalizationRegistry((({ watcher: t, signal: i }) => {
	t.unwatch(i);
})), h$3 = new WeakMap();
function e$3(e) {
	return !0 === e[i$2] ? (console.warn("SignalWatcher should not be applied to the same class more than once."), e) : class extends e {
		constructor() {
		...
		_$Sl() {
			...
			const i = this._$Su = new Signal.subtle.Watcher((function() {
				const t = h$3.get(this);
				void 0 !== t && (!1 === t._$Si && t.requestUpdate(), this.watch());
			}));
			h$3.set(i, this), s$1.register(this, {
				watcher: i,
				signal: this._$Sv
			}), i.watch(this._$Sv);
		}
		...
		update(t) {
			try {
				this._$So ? (this._$So = !1, super.update(t)) : this._$Sh.forEach(((t) => t.commit()));
			} finally {
				this.isUpdatePending = !1, this._$Sh.clear();
			}
		}
		requestUpdate(t, i, s) {
			this._$So = !0, super.requestUpdate(t, i, s);
		}
		connectedCallback() {
		...
		_(t) {
			this._$Sh.add(t);
			const i = this._$So;
			this.requestUpdate(), this._$So = i;
		}
		m(t) {
			this._$Sh.delete(t);
		}
...
function h$2(i) {
	void 0 !== this._$AN ? (o$6(this), this._$AM = i, r$2(this)) : this._$AM = i;
}
...
const c = (i) => {
	i.type == t$4.CHILD && (i._$AP ??= n$2, i._$AQ ??= h$2);
};
...
*/ var h$1 = class extends f {
	_$Sl() {
		...
		const i = this._$Su = new Signal.subtle.Watcher((() => {
			var t;
			null === (t = this._$SO) || void 0 === t || t._(this), i.watch();
		}));
		i.watch(this._$SW);
	}
	_$Sp() {
		var i;
		void 0 !== this._$Su && (this._$Su.unwatch(this._$SW), this._$SW = void 0, this._$Su = void 0, null === (i = this._$SO) || void 0 === i || i.m(this));
	}
	commit() {
		this.setValue(Signal.subtle.untrack((() => {
			var i;
			return null === (i = this._$SW) || void 0 === i ? void 0 : i.get();
		})));
	}
	render(i) {
	...
	update(i, [t]) {
		var h, o;
		return null !== (h = this._$SO) && void 0 !== h || (this._$SO = null === (o = i.options) || void 0 === o ? void 0 : o.host), t !== this._$Sj && void 0 !== this._$Sj && this._$Sp(), this._$Sj = t, this._$Sl(), Signal.subtle.untrack((() => this._$SW.get()));
	}
	disconnected() {
		this._$Sp();
	}
...
* Copyright 2023 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/ const m = (o) => (t, ...m) => o(t, ...m.map(((o) => o instanceof Signal.State || o instanceof Signal.Computed ? o$5(o) : o))), l$1 = m(b), r$1 = m(w);
